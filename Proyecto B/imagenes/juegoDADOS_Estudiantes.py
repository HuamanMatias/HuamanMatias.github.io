...
bg1 = pygame.image.load("./imagenes/bg/bg1.png")
boss1 = pygame.image.load("./imagenes/bg/boss1.png")
...
def evaluar_ronda():
    ...
    #Guardar esta información en la variable resultado en forma de texto.

    if jugador_suma == 10:
        resultado = "Ganaste!"
    elif jugador_suma > cpu_suma and jugador_suma < 10:
        resultado = "Ganaste!"
    elif jugador_suma < cpu_suma and cpu_suma < 10:
        resultado = "el CPU ganó!"    
    elif jugador_suma > 10:
        resultado = "Te pasaste!"
    elif cpu_suma > 10:
        resultado = "El CPU se pasó!"
    elif jugador_suma == cpu_suma or jugador_suma == 10 and cpu_suma == 10:
        resultado = "¡EMPATE!"
    else:
        resultado = "el CPU ganó"
...
def dibujar_juego():
    ...
    # Mostrar suma
    texto_j = fuente.render(f"Jugador: {jugador_suma}", True, NEGRO)
    texto_c = fuente.render(f"CPU: {cpu_suma}", True, NEGRO)
    ...
    # Resultado final
    if turno == "fin":
        texto_r = fuente.render(resultado, True, NEGRO)
